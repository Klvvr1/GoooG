...
export const CategoryCard: React.FC<CategoryCardProps> = ({
  ...
  return (
    <div
      ...
      className="group relative flex flex-col justify-end overflow-hidden rounded-3xl bg-stone-950 border border-stone-800/80 hover:border-stone-600 transition-all duration-300 hover:shadow-2xl hover:shadow-black/60 hover:-translate-y-1.5 cursor-pointer select-none h-[420px]"
    >
      ...
      <div className="relative z-10 p-6 flex items-baseline justify-between bg-gradient-to-t from-stone-950 via-stone-950/70 to-transparent">
        <h3 className="text-2xl font-extralight tracking-widest text-stone-100 group-hover:text-white transition-colors">
          {category.name}
        </h3>
        <span className="text-sm font-light text-stone-400 tracking-wider">
