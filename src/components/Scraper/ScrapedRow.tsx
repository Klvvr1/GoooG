...
import { Check, Plus, Image as ImageIcon, CheckCircle2 } from 'lucide-react';
...
export const ScrapedRow: React.FC<ScrapedRowProps> = ({
  ...
  return (
    ...
    >
      {/* Upper Row: Avatar, Name, Category, Action */}
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-xs text-zinc-400 mt-0.5 flex items-center gap-2">
              <span>{item.availableImages.length} photos available</span>
              <span>•</span>
        ...
        <div className="flex items-center gap-3">
          {isImported ? (
            <div className="flex items-center gap-1.5 px-4 py-2 rounded-xl bg-emerald-500/20 border border-emerald-500/30 text-emerald-300 text-xs font-bold">
              ...
              <span>Imported to Collection</span>
            </div>
          ) : (
            <button
              type="button"
            ...
            >
              ...
              <span>Import Character ({selectedCount} photos)</span>
            </button>
          )}
        </div>
      </div>
